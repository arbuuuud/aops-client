    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">GNT Club MLM System</a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
								...
								$data = $apicaller->sendRequest(array(
									...
									'username' => 'natalius',		//requirement for login function
									'name' => 'Natalius Sen',		//requirement for login function
									'tgllahir' => '09101987',	//requirement for login function // tidak kepake
									'tglaplikasi' => '09101987',	//requirement for login function // tidak kepake
									'sponsor_id' => 0,			//requirement for login function // tidak kepake
									'introducer_id' => 0 		//requirement for login function // tidak kepake
								));
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Dashboard GNT Club (Example)</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
